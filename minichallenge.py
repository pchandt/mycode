...
print(f"My name is {classinfo['all'][18]['name']} and my super power is {classinfo['all'][18]['super power']}.")

for i in classinfo['all']:
    print(f"{i['name']}, a {i['skill level']} of a programmer, possesses a  {i['super power']} factor for moolighting as a superhero!")
