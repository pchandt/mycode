...
def main():
    ...
    print(f"Player 3 rolled {player3.get_dice()}")

    # determine which player won
    if sum(player1.get_dice()) == sum(player2.get_dice()) == sum(player3.get_dice()):
        print("Draw!")
    elif sum(player1.get_dice()) > sum(player2.get_dice()):
        print("Player 1 wins!")
    elif sum(player1.get_dice()) > sum(player3.get_dice()):
        print("Player 1 wins!")
    elif sum(player3.get_dice()) > sum(player1.get_dice()):
        print("Player 1 wins!")
    elif sum(player3.get_dice()) > sum(player2.get_dice()):
        print("Player 1 wins!")
    else:
        print("Player 2 wins!")
